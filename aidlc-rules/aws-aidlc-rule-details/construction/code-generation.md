...
- [ ] Create explicit steps for unit generation:
  ...
  - Requirement/Story Verification Test Generation
...
- [ ] Include requirement/story verification mapping references from Workflow Planning
...
- [ ] For this unit, include:
  ...
  - Requirement/story acceptance criteria this unit must verify
  - Planned test files, scenarios, or assertions that will prove those criteria
...
- [ ] Generate or update tests required by the approved requirement verification plan
- [ ] Record any unautomated verification item as N/A with rationale in the unit code summary
...
```
     ...
     2. **AI Summary** (optional): Provide structured bullet-point summary
        ...
        - List requirement/story verification tests created or updated with paths
...
- All code and tests generated, including tests required to verify approved
  requirements, user stories, acceptance criteria, and contracts
- Any requirement/story without automated test evidence is explicitly marked
  N/A with rationale
