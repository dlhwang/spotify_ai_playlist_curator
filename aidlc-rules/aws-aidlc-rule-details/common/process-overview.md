...
**Note**: Similar content exists in welcome-message.md (user welcome message) and the project's AI-DLC documentation. This duplication is INTENTIONAL - each file serves a different purpose:
...
- **aidlc-docs/**: Project-specific planning, design, and implementation records
