...
**Requirement Verification**: Code Generation must generate or update the
tests required to verify approved requirements, user stories, acceptance
criteria, and contracts unless a test is explicitly marked N/A with rationale.
...
3. Generate comprehensive build and test instructions:
   ...
   - Requirement-level verification evidence mapping requirements and stories to executed tests
